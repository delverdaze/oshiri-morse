/* おしりモールス 変換コア（純粋ロジック）
   ブラウザ(classic script)とNode(CommonJS)の両対応。DOM・音声・kuromojiに非依存。 */
/* ===== おしりモールス 変換コア ===== */
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    encode, decode, toHiraReading, wordToKana,
    H2M, M2H, M2NUM, M2E, E2M, NUM2M,
    DASH, DOT, DASH_N, DOT_N, VS_RE, KANJI_RE, ROMAJI_IN, ROMAJI_OUT
  };
}
